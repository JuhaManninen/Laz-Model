...
<xsl:call-template name="description">
    <xsl:with-param name="doc" select="Foundation.Core.ModelElement.documentation" />
</xsl:call-template>
  <p/>
...
<xsl:template match="Foundation.Core.Class">
  ...
  <xsl:variable name="doc" select="Foundation.Core.ModelElement.documentation"/>
  <a name="{@xmi.id}"> </a>
...
<xsl:template match="Foundation.Core.Attribute">
  ...
  <tr>
    <td class="t_cell">
      <xsl:value-of select="Foundation.Core.ModelElement.name"/><br/>
<xsl:call-template name="description">
    <xsl:with-param name="doc" select="Foundation.Core.ModelElement.documentation" />
</xsl:call-template>
    </td>
...
<xsl:param name="doc"/>
<xsl:if test="$doc != ''">
<table class="Documentation" cellpadding="2" cellspacing="1" border="0" width="100%">
<tr><td>
